  ...
  if results.data.present?
    ...
    if completed_orders.present?
      ...
      completed_orders.each do | order |
        ...
        new_sale = Sale.new(user_id: User.last.id, customer_name: customer_details.data["customer"][:given_name], customer_locality: customer_details.data["customer"][:address][:locality],
